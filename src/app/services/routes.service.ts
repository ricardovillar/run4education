...
export class RoutesService {
  ...
  getFullRoute(): Observable<RoutePoint[]> {
    let routes: RoutePoint[] = [
      ...
      new RoutePoint("Tema (Ghana)", { lat: 5.6852424, lng: -0.0236622 }, "tema-balloon", "text"),
      ...
      new RoutePoint("Ouargla (Argelia)", { lat: 32.1805293, lng: 4.6419643 }, "ouargla-balloon", "text"),
      ...
      new RoutePoint("Málaga (España)", { lat: 36.7162981044559, lng: -4.4191724845630365 }, "malaga-balloon", "video"),
