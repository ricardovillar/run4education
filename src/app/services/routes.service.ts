...
export class RoutesService {
  ...
  getFullRoute(): Observable<RoutePoint[]> {
    let routes: RoutePoint[] = [
      ...
      new RoutePoint("Awjilah", { lat: 29.177884, lng: 21.336878 }, 26),  // intermediate point added to draw it better
      new RoutePoint("Maradah (Libia)", { lat: 29.215654, lng: 19.205641 }, 27),  // intermediate point added to draw it better
      new RoutePoint("Waddan (Libia)", { lat: 29.235141, lng: 16.103951 }, 28),  // intermediate point added to draw it better
      new RoutePoint("Tripoli (Libia)", { lat: 32.8829717, lng: 13.1708262 }, 29),
      new RoutePoint("Ghadames (Libia)", { lat: 30.1307602, lng: 9.478197 }, 30),
      new RoutePoint("Túnez", { lat: 33.8095826, lng: 5.0687704 }, 31),
      new RoutePoint("Ouargla (Argelia)", { lat: 32.1805293, lng: 4.6419643 }, 32, "nos van subiendo por muchas ciudades ,cada día a una distinta Asamasaud era una de ellas donde me pegaron mucho. Podemos hacer un vídeo de ousman"),
      new RoutePoint("Tamanrasset (Argelia)", { lat: 22.7907229, lng: 5.5177423 }, 33),
      new RoutePoint("Tessalit (Mali)", { lat: 20.2579848, lng: 0.9865814 }, 34),
      new RoutePoint("Abalessa (Argelia)", { lat: 22.938180, lng: 4.884270 }, 35),  // intermediate point added to draw it better
      new RoutePoint("Tamanrasset (Argelia)", { lat: 22.7907229, lng: 5.5177423 }, 36),
      new RoutePoint("Zelfana (Argelia)", { lat: 32.433797, lng: 4.199097 }, 37), // intermediate point added to draw it better
      new RoutePoint("Ouargla (Argelia)", { lat: 32.1805293, lng: 4.6419643 }, 38),
      new RoutePoint("Maghnia (Argelia)", { lat: 34.8496246, lng: -2.0538249 }, 39),
      new RoutePoint("Casablanca (Marruecos)", { lat: 33.5724108, lng: -7.657032 }, 40),
      new RoutePoint("Rabat (Marruecos)", { lat: 33.9693414, lng: -6.9273029 }, 41),
