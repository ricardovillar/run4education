...
export class RoutesService {
  ...
  getFullRoute(): Observable<RoutePoint[]> {
    let routes: RoutePoint[] = [
      ...
      new RoutePoint("Agadez (Níger) -> In Guezzam (Algeria)", { lat: 17.1148548, lng: 8.0816667 }),
      new RoutePoint("Agadez (Níger) -> In Guezzam (Algeria)", { lat: 17.195693, lng: 8.0963625 }),
      new RoutePoint("Agadez (Níger) -> In Guezzam (Algeria)", { lat: 17.7378475, lng: 7.9654285 }),
      new RoutePoint("Agadez (Níger) -> In Guezzam (Algeria)", { lat: 18.3224012, lng: 7.7626909 }),
      new RoutePoint("Agadez (Níger) -> In Guezzam (Algeria)", { lat: 18.7390917, lng: 7.3730276 }),
      new RoutePoint("Agadez (Níger) -> In Guezzam (Algeria)", { lat: 19.3339488, lng: 5.7691903 }),
      new RoutePoint("In Guezzam (Algeria)", { lat: 19.563837, lng: 5.7527483 }, "inguezzam-balloon"),
      new RoutePoint("In Guezzam (Níger) -> Hoggar Mountains (Algeria)", { lat: 23.0631336, lng: 5.3709624 }),
      ...
      new RoutePoint("Zwaia - Ghadames (Libia)", { lat: 30.4375878, lng: 10.3689736 }),
      new RoutePoint("Zwaia - Ghadames (Libia)", { lat: 30.4375878, lng: 10.3689736 }),
      new RoutePoint("Ghadames (Libia)", { lat: 30.1307602, lng: 9.478197 }, "ghadames-balloon"),
      ...
      new RoutePoint("Borj El Khadra (Túnez) -> Ouargla (Argelia)", { lat: 31.6291528, lng: 6.8042783 }),
      new RoutePoint("Borj El Khadra (Túnez) -> Ouargla (Argelia)", { lat: 31.8537269, lng: 5.6395636 }, "tunez-balloon"),
      ...
      new RoutePoint("Ouargla -> Tamanrasset (Argelia)", { lat: 22.651969, lng: 2.548545 }, "tamanrasset-balloon"),
      ...
      new RoutePoint("Guerguerat (Western Sahara) -> Nouakchott (Mauritania)", { lat: 18.46762779312631, lng: -16.01795276991613 }, "mauritania-balloon"),
      ...
      new RoutePoint("Nouakchott (Mauritania)", { lat: 18.079034644435794, lng: -15.965310650491222 }, "nouakchott-balloon", "video"),
